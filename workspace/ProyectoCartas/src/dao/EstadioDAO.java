	...
	public class EstadioDAO {
		...
		/**
		 * Inserta un nuevo estadio a la base de datos.
		...
		public boolean insertar(Estadio estadio) {
			...
			try {
				...
				if (resultado > 0) {
					...
					System.out.println("No se ha podido insertar el estadio");
				}
		 ...
		 * @return Objeto {@link Estadio} con los datos encontrados, o {@code null} si no existe.
		 */
		...
		public boolean actualizar(Estadio e) {
			...
			try {
				...
				if (resultado > 0) {
					System.out.println("Estadio actualizado correctamente");
					return true;
				} else {
					System.out.println("No se ha podido actualizar el estadio");
				}
		...
		public boolean eliminar(int id) {
			...
			try {
				...
				if (resultado > 0) {
					...
					System.out.println("No se ha podido eliminar el estadio");
				}
