...
public class Partida {
	...
	public void iniciarPartida() {
		...
		// SELECCION JUGADORES
		List<Jugador> jugadores = seleccionJugadores();
		
		// SELECCION ESTADIO
		Estadio estadio = seleccionEstadio();
	...
	protected List<Jugador> seleccionJugadores() {

		JugadorDAO j = new JugadorDAO();

		List<Jugador> aux = j.listar();

		List<Jugador> jugadores = new ArrayList<Jugador>();

		// TODO SELECCION MEDIANTE INTERFAZ

		jugadores.add(aux.get(0));
		jugadores.add(aux.get(1));

		return jugadores;

	}

	protected Estadio seleccionEstadio() {

		EstadioDAO e = new EstadioDAO();

		List<Estadio> estadios = e.listar();

		// TODO SELECION ESTADIO MEDIANTE INTERFAZ
