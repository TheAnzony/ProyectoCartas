...
public class Estadio {
	...
	public Estadio(int id_estadio, String nombre, String descripcion, int id_elemento_activo) {
		super();
	...
	public Estadio(String nombre, String descripcion, int id_elemento_activo) {
		super();
		this.nombre = nombre;
		this.descripcion = descripcion;
		this.id_elemento_activo = id_elemento_activo;
	...
	public String toString() {
		return "Estadio [id_estadio=" + id_estadio + ", nombre=" + nombre + ", descripcion=" + descripcion
				+ ", id_elemento_activo=" + id_elemento_activo + "]";
	}
